cost_qaly_run_with_treats=function(X,scale00,scale10,number_of_treats,treatduration){
  ...
  for ( i in 1 :20){
    ...
    Tqualy_vals00[i,]=calc_qalyv2(Xtest00,Tutility_vec[i],3)
    Xtest01=scale00*colSums(X[Tcompvec01[i,],]);
    Tqualy_vals01[i,]=calc_qalyv2(Xtest01,Tutility_vec[i],3)
    
    Xtest10=scale10*colSums(X[Tcompvec10[i,],]);
    Tqualy_vals10[i,]=calc_qalyv2(Xtest10,Tutility_vec[i],3)
    Xtest11=scale10*colSums(X[Tcompvec11[i,],]);
    Tqualy_vals11[i,]=calc_qalyv2(Xtest11,Tutility_vec[i],3)
  }
 ...
 for ( i in 1 :20){
   ...
   Tqualy_vals10_NSP[i,]=calc_qalyv2(Xtest10_NSP,Tutility_vec[i],3)
   Xtest11_NSP=scale10*colSums(X[Tcompvec11_NSP[i,],]);
   Tqualy_vals11_NSP[i,]=calc_qalyv2(Xtest11_NSP,Tutility_vec[i],3)
   
   Xtest10_OST=scale10*colSums(X[Tcompvec10_OST[i,],]);
   Tqualy_vals10_OST[i,]=calc_qalyv2(Xtest10_OST,Tutility_vec[i],3)
   Xtest11_OST=scale10*colSums(X[Tcompvec11_OST[i,],]);
   Tqualy_vals11_OST[i,]=calc_qalyv2(Xtest11_OST,Tutility_vec[i],3)
   
   Xtest10_NSP_OST=scale10*colSums(X[Tcompvec10_NSP_OST[i,],]);
   Tqualy_vals10_NSP_OST[i,]=calc_qalyv2(Xtest10_NSP_OST,Tutility_vec[i],3)
   Xtest11_NSP_OST=scale10*colSums(X[Tcompvec11_NSP_OST[i,],]);
   Tqualy_vals11_NSP_OST[i,]=calc_qalyv2(Xtest11_NSP_OST,Tutility_vec[i],3)
 }
 ...
 for ( i in 1 :7){
   Xtest00=scale00*colSums(X[Tcompvec00[i,],]);
   Tcost_vals00[i,]=calc_qalyv2(Xtest00,costsof[i],3)
   Xtest01=scale00*colSums(X[Tcompvec01[i,],]);
   Tcost_vals01[i,]=calc_qalyv2(Xtest01,costsof[i],3)
   
   Xtest10=scale10*colSums(X[Tcompvec10[i,],]);
   Tcost_vals10[i,]=calc_qalyv2(Xtest10,costsof[i],3)
   Xtest11=scale10*colSums(X[Tcompvec11[i,],]);
   Tcost_vals11[i,]=calc_qalyv2(Xtest11,costsof[i],3)
 }
 ...
 for ( i in 1 :7){
   ...
   Xtest10_NSP=scale10*colSums(X[Tcompvec10_NSP[i,],]);
   Tcost_vals10_NSP[i,]=calc_qalyv2(Xtest10_NSP,costsof[i],3)
   Xtest11_NSP=scale10*colSums(X[Tcompvec11_NSP[i,],]);
   Tcost_vals11_NSP[i,]=calc_qalyv2(Xtest11_NSP,costsof[i],3)
   
   Xtest10_OST=scale10*colSums(X[Tcompvec10_OST[i,],]);
   Tcost_vals10_OST[i,]=calc_qalyv2(Xtest10_OST,costsof[i],3)
   Xtest11_OST=scale10*colSums(X[Tcompvec11_OST[i,],]);
   Tcost_vals11_OST[i,]=calc_qalyv2(Xtest11_OST,costsof[i],3)
   
   Xtest10_NSP_OST=scale10*colSums(X[Tcompvec10_NSP_OST[i,],]);
   Tcost_vals10_NSP_OST[i,]=calc_qalyv2(Xtest10_NSP_OST,costsof[i],3)
   Xtest11_NSP_OST=scale10*colSums(X[Tcompvec11_NSP_OST[i,],]);
   Tcost_vals11_NSP_OST[i,]=calc_qalyv2(Xtest11_NSP_OST,costsof[i],3)
 }
 ...
 for ( i in 1 :2){
   ...
   Tcost_vals00[i,]=calc_qalyv2(Xtest00,costsof[9],3)
   Xtest01=multy[i]*scale00*colSums(X[Tcompvec01[i,],]);
   Tcost_vals01[i,]=calc_qalyv2(Xtest01,costsof[9],3)
   
   Xtest10=multy[i]*scale10*colSums(X[Tcompvec10[i,],]);
   Tcost_vals10[i,]=calc_qalyv2(Xtest10,costsof[9],3)
   Xtest11=multy[i]*scale10*colSums(X[Tcompvec11[i,],]);
   Tcost_vals11[i,]=calc_qalyv2(Xtest11,costsof[9],3)
 }
 ...
 for ( i in 1 :2){
   ...
   Tcost_vals10_NSP[i,]=calc_qalyv2(Xtest10_NSP,costsof[9],3)
   Xtest11_NSP=multy[i]*scale10*colSums(X[Tcompvec11_NSP[i,],]);
   Tcost_vals11_NSP[i,]=calc_qalyv2(Xtest11_NSP,costsof[9],3)
   
   Xtest10_OST=multy[i]*scale10*colSums(X[Tcompvec10_OST[i,],]);
   Tcost_vals10_OST[i,]=calc_qalyv2(Xtest10_OST,costsof[9],3)
   Xtest11_OST=multy[i]*scale10*colSums(X[Tcompvec11_OST[i,],]);
   Tcost_vals11_OST[i,]=calc_qalyv2(Xtest11_OST,costsof[9],3)
   
   Xtest10_NSP_OST=multy[i]*scale10*colSums(X[Tcompvec10_NSP_OST[i,],]);
   Tcost_vals10_NSP_OST[i,]=calc_qalyv2(Xtest10_NSP_OST,costsof[9],3)
   Xtest11_NSP_OST=multy[i]*scale10*colSums(X[Tcompvec11_NSP_OST[i,],]);
   Tcost_vals11_NSP_OST[i,]=calc_qalyv2(Xtest11_NSP_OST,costsof[9],3)
 }
