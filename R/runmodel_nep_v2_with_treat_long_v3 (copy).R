runmodel_nep_v2_with_treat_long_v3=function(scale00,scale10,TreatmentStartTime,
  ...
  if (DAAtreat$Pcurrenmild ==0 & DAAtreat$Pcurrenadva==0 & DAAtreat$Pformermild ==0 & DAAtreat$Pformeradva==0 & NSPOST$NSPcov==0 & NSPOST$OSTcov==0 & NSPOST$NSP_OSTcov==0){
  ...
  LDAAtreat=cost_qaly_run_with_treats(X[,73:91],scale00,scale10,p2$data$y,treatduration)
  p3=plot_output_mortality_v2_all_special(X,1-exp(-param_vals[913:916]),scale00,scale10,TreatmentStartTime,
