        ...
        titlePanel(
          title=div(img(src="Medicus-Economics-lg.png"), "HCV elimination model",style = "color: #FF0000"), windowTitle="HCV elimiation model"
                        ...
                        jumbotron("",h4("The aim of the HCV elimination model is to allow users to investigate the relative value of different routes towards the 
                                  ...
                                  of society and risky behaviors known to drive Hep C infection such as injection drug use, and estimate time to elimination 
                                  based on treatment reach and access and take-up of treatment options for the PWID population.
                        ...
                        fluidRow(
                          ...
                          content = h5("For DAA and NSP/OST intervention: ",actionLink(inputId = ns("link_pwidtab"), label = "Intervention PWID")," and ",actionLink(inputId = ns("link_gentab"), label = "Intervention gen pop"),
                                       HTML(strrep(br(), 1)),
                        ...
                        fluidRow(
                          column(6, panel_div("info", "Version Control", "Version 1, August 2, 2021")),
